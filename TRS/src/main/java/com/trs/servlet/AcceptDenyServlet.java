...
public class AcceptDenyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("in dopost of acceptdeny servlet");
		ObjectMapper mapper = new ObjectMapper();
		AcceptDeny ad = mapper.readValue(request.getInputStream(), AcceptDeny.class);
		List<Sentence> value = AcceptDenyDAOImpl.acceptDenyApplication(ad.getFormId(), ad.getAcceptDeny(), ad.getAccType(), ad.getReason());
